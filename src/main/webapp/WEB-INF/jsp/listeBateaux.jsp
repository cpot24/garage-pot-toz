                	...
                	"aoColumns": [
                	    ...
                	    { "sWidth" : "20%"},
                	    {
                            ...
                            "fnRender": function ( oObj ) {
                                var lien="<a href=\"/collaborateurMajBateau?id_bateau="+oObj.aData[0]+"\"><img src=\"/static/img/detail.jpg\" width=\"15\" height=\"15\" /></a>";
                                var lien2="<a href=\"/responsableSuppressionBateau?id_bateau="+oObj.aData[0]+"\"><img src=\"/static/img/remove.jpg\" width=\"15\" height=\"15\" /></a>";

                                return lien+lien2;
                            }
                	    }
                	],
                    "sAjaxSource": "/jsonListeBateaux"
                });
            } );
        </script>
    </head>
